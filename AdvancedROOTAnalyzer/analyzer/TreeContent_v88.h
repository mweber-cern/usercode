...
class TreeContent {
 public :
  ...
  int* pack(const char* c) {
   ...
   Int_t           noise_HBHE_filter_result;
   Int_t           eventfilter_n;
   ...
   Double_t        ele_caloEtCorr[100];   //[ele_n]
   Double_t        ele_EoverPCorr[100];   //[ele_n]
   Double_t        ele_HCalOverEmCorr[100];   //[ele_n]
   Double_t        ele_HCalOverEmBcCorr[100];   //[ele_n]
   Int_t           pfele_n;
   ...
   TBranch        *b_ele_SCEt;   //!
   TBranch        *b_ele_caloEtCorr;   //!
   TBranch        *b_ele_EoverPCorr;   //!
   TBranch        *b_ele_HCalOverEmCorr;   //!
   TBranch        *b_ele_HCalOverEmBcCorr;   //!
   TBranch        *b_pfele_n;   //!
   TBranch        *b_pfele_p;   //!
   TBranch        *b_pfele_E;   //!
   TBranch        *b_pfele_Et;   //!
