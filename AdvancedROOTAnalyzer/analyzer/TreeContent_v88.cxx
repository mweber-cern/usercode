...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/net/scratch_cms/institut_3a/gueth/MC_comparison_lp211/Herwig/out_1_1_vuK.root");
      if (!f) {
         f = new TFile("/net/scratch_cms/institut_3a/gueth/MC_comparison_lp211/Herwig/out_1_1_vuK.root");
         f->cd("/net/scratch_cms/institut_3a/gueth/MC_comparison_lp211/Herwig/out_1_1_vuK.root:/ACSkimAnalysis");
      }
...
void TreeContent::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ele_caloEtCorr", ele_caloEtCorr, &b_ele_caloEtCorr);
   fChain->SetBranchAddress("ele_EoverPCorr", ele_EoverPCorr, &b_ele_EoverPCorr);
   fChain->SetBranchAddress("ele_HCalOverEmCorr", ele_HCalOverEmCorr, &b_ele_HCalOverEmCorr);
   fChain->SetBranchAddress("ele_HCalOverEmBcCorr", ele_HCalOverEmBcCorr, &b_ele_HCalOverEmBcCorr);
