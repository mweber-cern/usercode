...
export here=$PWD
export reportFile=PetalGeometryValidation.log
...
#cp $referenceDir/matbdg_Petal.root           matbdg_Petal_old.root 
#echo "...done" | tee -a $reportFile
#
...
#
echo "Running Petal..." | tee -a $reportFile
rm -rf Petal.txt
cmsRun $CMSSW_BASE/src/Validation/Geometry/test/runP_Petal.cfg           > Petal.txt
echo "...done" | tee -a $reportFile
#
ln -s matbdg_Petal.root           matbdg_Petal_new.root 
echo "...done" | tee -a $reportFile
#

# Produce the 'new' plots
echo "Run the Tracker macro MaterialBudget.C to produce the 'new' plots..." | tee -a $reportFile
root -b -q 'MaterialBudgetPetal.C("Petal")'
echo "...done" | tee -a $reportFile
#
...
#root -b -q 'TrackerMaterialBudgetComparison.C("Petal")'
#echo "...done" | tee -a $reportFile
#
